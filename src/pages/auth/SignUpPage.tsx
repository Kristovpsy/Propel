    ...
    <div className="card p-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        ...
        >
          ...
          <p className={`font-semibold text-sm ${selectedRole === 'mentee' ? 'text-brand-green-700' : 'text-slate-600 dark:text-slate-400'}`}>Mentee</p>
        ...
        >
          ...
          <p className={`font-semibold text-sm ${selectedRole === 'mentor' ? 'text-brand-blue-700' : 'text-slate-600 dark:text-slate-400'}`}>Mentor</p>
      ...
      <button onClick={handleGoogleSignUp} className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-slate-200 rounded-xl hover:bg-slate-50 transition-colors font-medium text-sm text-slate-700 dark:text-slate-300">
